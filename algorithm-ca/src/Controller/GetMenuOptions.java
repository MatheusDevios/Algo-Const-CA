...
public class GetMenuOptions {
    ...
    public void getMenuOptions() throws IOException {
        ...
        do {
            ...
            switch (optionChosen) {
                ...
                System.out.println("You choosed to search a student!");
                    ...
                    switch (studentCategory) {
                        case 1:
                            ...
                            Students resultStudentN = search.binarySearchStudent(sortedStudentsN,
                                    studentFullName.toLowerCase(), 1);
                ...
                System.out.println("You choosed to borrow a book!");
                    ...
                    if (bookSearched.toLowerCase().contains(bookNameBorrowed.toLowerCase())) {
                        ...
                        //If the booked is borrowed, the user have the option to add the student in a waiting list
                        System.out.println("\nThis book is borrowed, let me add you on the waiting list.");
                        System.out.println("Option 1 = Yes.\n"
                                + "Option 2 = No.\n");
                        int queueOption = input.getUserIntValue("Select the number corresponding to your intention.", 1,
                                2);

                        switch (queueOption) {
                            // Option 1: Add the student to the queue list
                            case 1:
                                data.bookQueue(bookData);
                                queue = data.loadQueue();
                                break;
                            // Option 2: Do not add the student to the queue list
                            case 2:
                ...
                System.out.println("You choosed to return a book!");
                    ...
                    // split in order to get the studentID
                ...
                System.out.println("You choosed to list all books borrowed by a student!");
                    ...
                    break;
                case 8:
                    // Close the menu and shows a message to the user saying that they chose to
                    // finish it.
            ...
            // condition to run until the option chosen from the user is 8
            // and then finish the application.
        } while (optionChosen != 8);
        System.out.println("\n Thank you for using CCT Library System!");
    }
