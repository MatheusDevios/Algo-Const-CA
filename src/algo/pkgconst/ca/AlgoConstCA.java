        ...
        switch (option){
            ...
            case 2:
                while (leftIndex < left.size() && rightIndex < right.size()) {
                    ...
                    if (left.get(leftIndex).get(0).compareTo(right.get(rightIndex).get(0)) < 0 ) {
...
//BufferedWriter myWriter = new BufferedWriter(new FileWriter("Clean.txt"));
//
//// for loop to write in the Clean file the number in reverse order
////it starts at the last position and goes until the first position, decreasing one by one
//for (int i = myList.size()-1; i >= 0; i--) {
//
////add a new line and wirte the value in the Clean file
//    myWriter.newLine();
//    myWriter.write(Integer.toString(myList.get(i)));
//
//}
//
//// saves the clean file
//myWriter.close();


//studentId name, mobile phone, email, 
//[[f9247e51-2599-4acf-b645-0a468f7f5d30, Nicolea, Whyard, "League of Ordinary Gentlemen,  A", Documentary],[studentID, data] , reserveList[,studentID]]